...
export const MagicWandIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M15 4V2"></path><path d="M15 10V8"></path>
        <path d="M12.5 7.5L14 6"></path><path d="M17.5 7.5L16 6"></path>
        <path d="m3 21 9-9"></path><path d="M12.5 2.5L14 4"></path>
        <path d="M17.5 2.5L16 4"></path><path d="M21 15h2"></path>
        <path d="M17 15h2"></path><path d="M21 12.5L22 11"></path>
        <path d="M17 12.5L18 11"></path><path d="M21 17.5L22 16"></path>
        <path d="M17 17.5L18 16"></path>
    </svg>
);

export const VintageCameraIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const SuperheroMaskIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M5.52 15.63A2.2 2.2 0 0 1 4 14.11V10.5a2.5 2.5 0 0 1 2.5-2.5h11A2.5 2.5 0 0 1 20 10.5v3.61a2.2 2.2 0 0 1-1.52 2.12Z"></path>
        <path d="M3 11a8 8 0 0 1 8-8h2a8 8 0 0 1 8 8"></path>
    </svg>
);
...
export const SparklesIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M4 19v-4"></path><path d="M2 17h4"></path>
    </svg>
);
...
export const SkullIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="M12 16a9 9 0 0 0 9-9V5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v2a9 9 0 0 0 9 9z"></path>
  </svg>
);
